...
Grid::Node* Grid::GetNode(int x, int y) { return &(_nodes[y][x]); }
...
bool Grid::IsEmpty(int x, int y) { return GetNode(x, y)->IsEmpty(); }
...
int Grid::Node::FValue() const { return g + h; }

bool Grid::Node::IsEmpty() const { return state == Grid::Node::State::kEmpty; }
